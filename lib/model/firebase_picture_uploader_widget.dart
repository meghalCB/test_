...
class _SingleProfilePictureUploadWidgetState
  ...
  Future _uploadImage() async {
    ...
    if (widget.pictureUploadWidget.settings.imageManipulationSettings.enableCropping) {
      // finalImage = await widget.pictureUploadController.cropImage(File(image.path), widget.pictureUploadWidget.settings.imageManipulationSettings);
    }
